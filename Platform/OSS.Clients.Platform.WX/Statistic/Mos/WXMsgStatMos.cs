...
namespace OSS.SocialSDK.WX.Offcial.Statistic.Mos
{
    ...
    /// 消息统计实体
    /// </summary>
    public class WXChatUpStatMo: WXChatStatBaseMo
    {
        /// <summary>   
    ...
    /// 消息时分统计实体
    /// </summary>
    public class WXChatUpStatHourMo: WXChatUpStatMo
    {
        /// <summary>   
    ...
    ///  消息分布统计实体
    /// </summary>
    public class WXChatUpStatDistMo : WXChatStatBaseMo
    {
        /// <summary>   
